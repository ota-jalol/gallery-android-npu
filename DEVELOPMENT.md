...
The application now supports Neural Processing Unit (NPU) acceleration for improved ML inference performance on compatible devices. See [NPU_SUPPORT.md](NPU_SUPPORT.md) for detailed information about NPU support, usage, and device compatibility.
